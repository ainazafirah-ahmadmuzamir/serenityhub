    ...
    <main class="card" role="main">
      <section class="left" aria-labelledby="signup-title">
        <div>
          ...
          <h2 id="signup-title">Welcome Back!</h2>
        </div>
        ...
        <c:if test="${param.logout == 'success'}">
          <div class="alert success">You have logged out successfully.</div>
        </c:if>
      ...
      <aside class="right" aria-hidden="false">
        <div>
          ...
          <div class="welcome-sub">Continue your journey with SerenityHub.</div>
          <p class="footer">
            New to SerenityHub? <a href="signup.jsp">Sign Up for free</a>
          </p>
          <p class="footer">
